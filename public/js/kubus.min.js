...
(f.show(),c.shouldRenderPerspectives(!0),b.attr("class","open"),b.text("\u2193"))});a("#modal").click(function(a){"DIV"==a.target.tagName&&k()});a("#modal").on("click","a",function(b){b.preventDefault();if(a(this).hasClass("color"))b=a(this).attr("href"),void 0!=r&&a("#cube").removeClass("color-"+r.substring(1)),r=b,a("#cube").addClass("color-"+r.substring(1)),"#random"==b&&(b=g[Math.floor(Math.random()*(g.length-1))]),c.setCubeMaterial(b),x(a("#cube")),k();else if(a(this).hasClass("sizeControl"))a:{b=
...
n)*n+n/2)):h.position.divideScalar(n).floor().multiplyScalar(n).addScalar(n/2);0<h.position.y&&!t(h.position)&&(v.add(h),l.push(h),q=6,setTimeout(function(){B()},0))}}function t(a){for(var h=1;h<l.length;h++)if(a.equals(l[h].position))return!0;return!1}function r(){var z=new THREE.PerspectiveCamera(45,a.width()/a.height(),1,1E4);z.position.set(500,800,1300);z.lookAt(new THREE.Vector3);return z}function b(){var a=[],h=e/7,b=new THREE.Geometry;b.vertices.push(new THREE.Vector3(e+h,0,e));b.vertices.push(new THREE.Vector3(e+
...
a.add(P);a.add(H);b().forEach(function(b,c,e){a.add(b)});return a}function O(a){a.object!=H&&(v.remove(a.object),l.splice(l.indexOf(a.object),1),q=6,setTimeout(function(){B()},0))}function N(){requestAnimationFrame(N);C.render(v,A)}function I(){for(var a=new THREE.Geometry,b=-e;b<=e;b+=n)a.vertices.push(new THREE.Vector3(-e,0,b)),a.vertices.push(new THREE.Vector3(e,0,b)),a.vertices.push(new THREE.Vector3(b,0,-e)),a.vertices.push(new THREE.Vector3(b,0,e));b=new THREE.LineBasicMaterial({color:0,opacity:.2,
...
A),h=K.intersectObjects(l),0<h.length))switch(h=h[0],b.button){case 0:L?c(h):O(h);break;case 2:O(h)}}var n,e,l,G,v,A,C,u,K,D,J,P,H,y,p,L=!0,E=this,S=d||[],R={},w={},q=0;this.perspective=function(a){};this.clearCubes=function(){for(var a=1;a<l.length;a++)v.remove(l[a]);l.splice(1,l.length);B()};this.enableOrDisableOrbit=function(a){return"boolean"===typeof a?(y.enabled=a,!0):!1};this.loadModel=function(a){var b,c=u;a="object"===typeof a?a:JSON.parse(a);a=JSON.parse(LZString.decompressFromBase64(a.model));
l=[];e=n/2*a.baseSize;I();v=F();for(var d=0,g=a.cubes.length;d<g;d++)b="#"+a.cubes[d].color,E.setCubeMaterial(b),b=new THREE.Mesh(G,w[b]),b.position.x=a.cubes[d].x,b.position.y=a.cubes[d].y,b.position.z=a.cubes[d].z,v.add(b),l.push(b);B();f();E.renderPerspectives();u=c};this.renderPerspectives=function(){p.forEach(function(a,b,c){a.setSize();a.render()})};this.resizePerspectives=function(){p.forEach(function(a){a.setSize()})};this.resize=function(){A.aspect=a.width()/a.height();A.updateProjectionMatrix();
C.setSize(a.width(),a.height());E.renderPerspectives()};this.saveModel=function(){function a(b,c,d,e){this.color=b;this.x=c;this.y=d;this.z=e}for(var b={baseSize:l[0].geometry.parameters.height/n,cubes:[],step:n/2},c=1;c<l.length;c++){var d=l[c].material.map.sourceFile,d=d.replace("public/img/textures/",""),d=d.replace(".png","");b.cubes.push(new a(d,l[c].position.x,l[c].position.y,l[c].position.z))}return LZString.compressToBase64(JSON.stringify(b))};this.setBaseSize=function(a){return!isNaN(a)&&
1<=a&&10>=a?(e=n/2*a,l=[],I(),g(),v=F(),f(),B(),q=6,!0):!1};this.getBaseSize=function(){return e/(n/2)};this.setCubeMaterial=function(a){return/^#([A-Fa-f0-9]{6})$/.test(a)?(Detector.webgl?void 0==w[a]?(u=new THREE.MeshBasicMaterial({map:R[a.toUpperCase()]||THREE.ImageUtils.loadTexture("public/img/textures/"+a.toUpperCase().substring(1)+".png")}),w[a]=u):u=w[a]:void 0==w[a]?(u=new THREE.MeshBasicMaterial({color:a}),w[a]=u):u=w[a],!0):!1};this.toggleBuildMode=function(){this._buildMode=L=!L};this.shouldRenderPerspectives=
function(a){p.forEach(function(b){b.shouldRender(a)});p[5].shouldRender(!0);a&&(q=6,E.resizePerspectives())};(function(){if(!(a instanceof jQuery))throw Error();for(var b=0;b<k.length;b++)if(!(k[b]instanceof jQuery))throw Error();S.forEach(function(a){requestAnimationFrame(function(){THREE.ImageUtils.loadTexture("public/img/textures/"+a.toUpperCase().substring(1)+".png",void 0,function(b){R[a]=b})})});E.setCubeMaterial("#FBE430");jQuery.Event("updateView");n=50;l=[];p=[];G=new THREE.BoxGeometry(n,
n,n);K=new THREE.Raycaster;D=new THREE.Vector2;J=new THREE.Vector2;e=250;I();v=F();A=r();C=M(a,!0);y=new THREE.OrbitControls(A,C.domElement);y.noPan=!0;g();a.append(C.domElement);a[0].addEventListener("mousedown",Q);a[0].addEventListener("mouseup",Q);f();setTimeout(function(){N()},1E3)})();setInterval(function(){requestAnimationFrame(function(){0<q&&p[0].render()&&q--})},400);setInterval(function(){requestAnimationFrame(function(){0<q&&p[1].render()&&q--})},400);setInterval(function(){requestAnimationFrame(function(){0<
q&&p[2].render()&&q--})},400);setInterval(function(){requestAnimationFrame(function(){0<q&&p[3].render()&&q--})},400);setInterval(function(){requestAnimationFrame(function(){0<q&&p[4].render()&&q--})},400);setInterval(function(){requestAnimationFrame(function(){0<q&&p[5].render()&&q--})},400)};x.View=function(a,k,d,g,c){var t=!0;this.render=function(){return t?(a.render(g,k),!0):!1};this.setSize=function(){var g=2*c-10;"topView"==d.attr("id")?g=2*c+c/20:"preview"==d.attr("id")&&(g=2*c+c/2);var b=
d.width()/d.height();a.setSize(d.width(),d.height());k.left=b*g/2;k.right=-b*g/2;k.top=g/2;k.bottom=-g/2;k.updateProjectionMatrix()};this.init=function(){d.empty();d.append(a.domElement)};this.shouldRender=function(a){t=a}}})(window);jQuery(document).ready(function(){$(window.applicationCache).on("updateready",function(a){window.applicationCache.swapCache()})});
...
new Date((new Date(g[k].date)).getTime()+2592E6),b=new Date;b.setHours(0,0,0,0);if(r>=b.getTime()){if(250<=c)break;d[k]=g[k];c+=1}}localStorage.setItem("buildings",JSON.stringify(d))};this.saveNewBuilding=function(d,g,c){d=d.trim().toLowerCase();if(a(d,m()))return!1;var t={};c&&(g=LZString.compressToBase64(g));var r=new Date;c=r.getDate();10>c&&(c="0"+c);var b=r.getMonth()+1;10>b&&(b="0"+b);r=r.getFullYear();t[d]={model:g,date:r+"-"+b+"-"+c};k.saveBuildings(t);return!0}}})(window);